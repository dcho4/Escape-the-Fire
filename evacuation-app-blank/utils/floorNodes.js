...
const FLOOR_1_ACCESSIBLE_NODE_IDS = {
  ...
  f1_hall_move_e: ["f1_room_move_3", "f1_room_move_4", "f1_room_move_e_upper", "f1_room_move_e_lower", "f1_hall_e"],
  f1_room_move_e_upper: ["f1_hall_move_e"],
  f1_room_move_e_lower: ["f1_hall_move_e"],
  ...
  f1_hall_e: ["f1_exit_2", "f1_hall_mid", "f1_hall_e_pre", "f1_stairs_e2", "f1_room_plain_3", "f1_hall_move_e"],
  f1_room_plain_3: ["f1_hall_e"],
...
const FLOOR_2_ACCESSIBLE_NODE_IDS = {
  ...
  f2_hall_e1: ["f2_hall_e2", "f2_hall_w4", "f2_hall_w5", "f2_hall_n1", "f2_room_cafe_2"],
  ...
  f2_hall_test: ["f2_hall_n1", "f2_exit_1", "f2_hall_n2", "f2_room_basketball"],
  f2_hall_w1: [
    "f2_hall_w_exit_w1",
    "f2_hall_w_jog",
    "f2_hall_w2",
  ...
  f2_hall_w4: ["f2_hall_w3", "f2_hall_w5", "f2_hall_e1", "f2_room_cafe", "f2_room_cafe_2", "f2_room_cafe_3"],
  ...
  f2_room_north_private: ["f2_exit_north_private"],
  f2_exit_north_private: ["f2_room_north_private"],
  ...
  f2_room_cafe: ["f2_hall_w4", "f2_hall_w5", "f2_room_cafe_3"],
...
const NODES_BY_FLOOR = {
  ...
  1: [
    ...
    {
      id: "f1_room_move_e_upper",
      label: "Room · movement E (upper)",
      floor: 1,
      type: "room",
      x: 0.5803,
      y: 0.465,
    ...
    {
      id: "f1_room_move_e_lower",
      label: "Room · movement E (lower)",
      floor: 1,
      type: "room",
      x: 0.5796,
      y: 0.4777,
  ...
  2: [
    ...
    {
      id: "f2_room_north_private",
      label: "Room · N private",
      floor: 2,
      type: "room",
      x: 0.4958,
      y: 0.3778,
    ...
    { id: "f2_exit_north_private", label: "Exit · N private", floor: 2, type: "exit", x: 0.4865, y: 0.3806 },
